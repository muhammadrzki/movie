...
<body>
  ...
  $tgl_habis = date('Y-m-d ', strtotime('+6 month'));
  ?>
  <div class="container">
    ...
    <div class="row featurette">
      <div class="col-md-7">
        <h2 class="featurette-heading">Paket Standar <span class="text-muted"></span>
        </h2>
        <p class="lead">
          Apabila pengguna tinggal bersama pasangan atau berbagi apartemen dengan teman, disarankan untuk memilih Paket
          Standar senilai Rp 120.000 per 6 bulan.

          Paket ini menawarkan fitur video full HD untuk meningkatkan pengalaman menonton di TV maupun ponsel
          berkualitas HD,
          serta memungkinkan pengguna menikmati tayangan Flixmo 21 di dua perangkat sekaligus (ponsel, tablet, TV,
          laptop,
          atau komputer).</p>
      </div>
      <div class="col-md-5">
  ...
  <body>
    <div class="container-fluid">
      ...
      <div class="card shadow mb-4">
        <div class="card body">
          <form method="post" action="<?= base_url() ?>berlangganan1/checkout">
            ...
            <div class="form-group col-md-12">
              ...
              <input type="text" name="jenis_paket" class="form-control" value="Paket Standar" readonly>
            </div>
            <div class="form-group col-md-12 " hidden>
            ...
            <div class="form-group col-md-12">
              ...
              <input type="text" name="harga" class="form-control" value="Rp 120.000" readonly>
            </div>
            <div class="form-group col-md-12">
