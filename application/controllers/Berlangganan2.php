...
class Berlangganan2 extends CI_Controller
{

  public function index()
  {
    $this->load->view('berlangganan/langganan2',);
  }
  public function v_langganan2()
  {
    $isi['content'] = 'berlangganan/v_langganan2';
    $isi['judul'] = 'Form Berlangganan Flixmo 21';
    $isi['kode_pelanggan'] = $this->m_langganan->generate_kode_langganan();
    $this->load->view('berlangganan/v_langganan2', $isi);
  }
