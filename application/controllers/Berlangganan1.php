...
class Berlangganan1 extends CI_Controller
{

  public function index()
  {
    $this->load->view('berlangganan/langganan1',);
  }
  public function v_langganan1()
  {
    $isi['content'] = 'berlangganan/v_langganan1';
    $isi['judul'] = 'Form Berlangganan Flixmo 21';
    $isi['kode_pelanggan'] = $this->m_langganan->generate_kode_langganan();
    $this->load->view('berlangganan/v_langganan1', $isi);
  }
